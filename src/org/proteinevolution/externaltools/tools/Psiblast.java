...
public final class Psiblast extends ExternalToolInvocation<ISequenceAlignment, Path> {
	...
	// Parameters
	public final Parameter<Path> database = new Parameter<Path>(Paths.get(""), "Database");
