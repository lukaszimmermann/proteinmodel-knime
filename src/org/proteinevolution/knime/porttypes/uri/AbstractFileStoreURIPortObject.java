 ...
 */
package org.proteinevolution.knime.porttypes.uri;
...
public abstract class AbstractFileStoreURIPortObject extends
     ...
     */
    public File registerFile(final String filename) {
        // register the URIContent
        File child = new File(getFileStoreRootDirectory(), filename);
        
        String[] spt = filename.split("\\.");
        URIContent uric = new URIContent(child.toURI(), spt[spt.length - 1]);
