...
public class HHsuiteDBPortObject extends AbstractPortObject {
	...
	protected void load(
	    ...
	    Class<HHsuiteDB> contentCl;
	    try {
	        contentCl = (Class<HHsuiteDB>) Class.forName(contentClName);
	        
	    } catch (ClassNotFoundException ex) {
	        throw new IOException("Error converting to HHsuiteDB Class", ex);
	    }
	    
	    Constructor<HHsuiteDB> cons;
	    try {
